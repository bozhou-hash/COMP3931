...
def main():
    ...
    dqn_vs_minimax_paths = [
        ...
        "results/imitation_tactical_eval/dqn_vs_minimax.json",
    ...
    for path in dqn_vs_minimax_paths:
        data = load_json(path)
    ...
    plt.plot(x, loss_rates, marker="o", linewidth=2, label="Minimax win rate")
    ...
    plt.ylabel("Rate")
    plt.xlabel("Agent")
    plt.title("All Agents vs Minimax (Depth 4)")
    ...
    output_path = os.path.join(
        ...
        "results",
        "figures",
        "all_agents_vs_minimax_depth4.png",
    )
