...
def select_greedy_action(q_network, state, legal_actions, device):
    ...
    masked_q_values = get_valid_q_values(q_values, legal_actions)
...
def train_step(q_network, target_network, replay_buffer, optimizer, batch_size, gamma, device):
    ...
    with torch.no_grad():
        ...
        # Terminal states should have no bootstrapped future value
